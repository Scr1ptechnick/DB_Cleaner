/* ============================================================
   BASE DE DATOS: cleaner (jardineria)
   CONTENIDO: Estructura, Datos y Consultas con DESCRIBE
   ============================================================ */


/* ============================================================
   SECCIÓN 1 - CREACIÓN DE BASE DE DATOS Y TABLAS
   ============================================================ */
...
/* ============================================================
   SECCIÓN 3 - CONSULTAS DML CON DESCRIBE
   ============================================================ */


/* ------------------------------------------------------------ */
/* A. Listado completo de oficinas                              */
/* ------------------------------------------------------------ */
...
/* ------------------------------------------------------------ */
/* B. Solo código de oficina y ciudad                           */
/* ------------------------------------------------------------ */
...
/* ------------------------------------------------------------ */
/* C. Ciudad y teléfono de las oficinas de España               */
/* ------------------------------------------------------------ */
...
/* ------------------------------------------------------------ */
/* D. Nombre, apellidos y email de empleados cuyo               */
/*    jefe tiene código de jefe igual a 7                       */
/* ------------------------------------------------------------ */
...
/* ------------------------------------------------------------ */
/* E. Puesto, nombre, apellidos y email del jefe de la empresa  */
/* ------------------------------------------------------------ */
...
/* ------------------------------------------------------------ */
/* F. Empleados que NO son Representantes de Ventas             */
/* ------------------------------------------------------------ */
...
/* ------------------------------------------------------------ */
/* H. Estados distintos que existen en los pedidos              */
/* ------------------------------------------------------------ */
...
/* ------------------------------------------------------------ */
/* I. Clientes con pagos realizados en 2008                     */
/* ------------------------------------------------------------ */
...
-- Opción 2: con DATE_FORMAT()
SELECT DISTINCT codigo_cliente
FROM pago
WHERE DATE_FORMAT(fecha_pago, '%Y') = '2008';

-- Opción 3: con rango de fechas
SELECT DISTINCT codigo_cliente
FROM pago
...
/* ------------------------------------------------------------ */
/* K. Pedidos entregados al menos 2 días antes de lo esperado  */
/* ------------------------------------------------------------ */

DESCRIBE pedido;

-- Opción 1: con ADDDATE()
SELECT codigo_pedido,
       codigo_cliente,
       fecha_esperada,
       fecha_entrega
...
/* ------------------------------------------------------------ */
/* M. Pedidos entregados en el mes de enero                     */
/* ------------------------------------------------------------ */
...
/* ------------------------------------------------------------ */
/* N. Pagos con PayPal en 2008 ordenados por total DESC         */
/* ------------------------------------------------------------ */
